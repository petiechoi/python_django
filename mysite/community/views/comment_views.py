...
def comment_create_question(request, question_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect('{}#comment_{}'.format(resolve_url('community:detail',question_id=comment.question.id),comment.id))
    else:
...
def comment_create_answer(request, answer_id):
    ...
    if request.method == 'POST' :
        ...
        if form.is_valid():
            ...
            return redirect('{}#comment_{}'.format(resolve_url('community:detail', question_id = comment.answer.question.id),comment.id))
    else:
        form = CommentForm()
    context = {'form' : form}
    return render(request, 'community/comment_form.html', context)
